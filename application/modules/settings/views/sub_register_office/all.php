    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Sub Register Office List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url()?>">Home</a></li>
              <li class="breadcrumb-item active">General Settings</li>
              <li class="breadcrumb-item active">Sub Register Office</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Sub Register Office Information</h3>
            <div class="card-tools">
              ...
              <a class="btn btn-primary btn-sm" href="<?=base_url('settings/sub_register_office_add')?>">Add New <i class="fas fa-plus"></i></a>
              ...
              <div class="col-md-12">
                <table id="example2" class="text-center table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Sub Register Office Name</th>
                    <th>Action</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$row->name_en;?></td>
                    <td>
                      <a class="btn btn-info btn-sm" href="<?=base_url('settings/sub_register_office_edit/'.$row->id)?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?=base_url('settings/sub_register_office_delete/'.$row->id)?>:" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a>
                    </td>
                  </tr>
                <?php } } ?>
                </tbody>
