        ...
        <div class="card card-success">
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              <a class="btn btn-primary btn-sm" href="<?=base_url('settings/division_add')?>">Add New <i class="fas fa-plus"></i></a>
              ...
              <div class="col-md-12">
                <table id="example2" class="text-center table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?=$row->name_bn;?></td>
                    <td>
                      <a class="btn btn-info btn-sm" href="<?=base_url('settings/division_edit/'.$row->id)?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?=base_url('settings/division_delete/'.$row->id)?>:" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a>
                    </td>
                  </tr>
                <?php } } ?>
                </tbody>
