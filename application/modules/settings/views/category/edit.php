                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input type="text" name="category_name" value="<?=$info->category_name?>" class="form-control form-control-sm">
                        </div>
                     </div>

                     <div class="col-md-4">
                        <div class="form-group">
                           <label>Product Category Image</label><span style="font-size: 11px;">(if Change)</span>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label>Product Category Old Image</label>
                           <div><?php echo form_error('sub_category_img_file'); ?></div>
                           <input type="hidden" name="old_img_file" value="<?=$info->category_img?>">
                              <?php if ($info->category_img) {?>
                              <a href="<?=base_url('uploads/category_image/'.$info->category_img)?>" target="_blank"><img style="max-height: 50px; max-width: 50px; margin-left: 25px;" src="<?=base_url('uploads/category_image/'.$info->category_img)?>"></a>
                          <?php } ?>
                        </div>
                     </div>   
                  </div>
