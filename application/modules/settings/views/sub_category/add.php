      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card card-success">
               ...
               <?php endif; ?>
               <?php echo form_open_multipart("settings/product_sub_category_add");?>
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select name="category_name" id="category_name" class="distirict_val form-control form-control-sm">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="sub_category_name" value="<?=set_value('sub_category_name')?>" class="form-control form-control-sm">
                        </div>
                     </div>
