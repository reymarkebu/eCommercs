      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Police Stations Information</h3>
            <div class="card-tools">
              ...
              <a class="btn btn-primary btn-sm" href="<?=base_url('settings/police_station_add')?>">Add New <i class="fas fa-plus"></i></a>
            ...
            <div class="row">
              <div class="col-md-12">
                <table id="example2" class="text-center table table-bordered table-striped">
                  ...
                  <tr>
                    <th>SL No.</th>
                    <th>Police Station Name (in English)</th>
                    <th>Police Station Name (in Bengali)</th>
                    <th>Action</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$row->name_bn;?></td>
                    <td>
                      <a class="btn btn-info btn-sm" href="<?=base_url('settings/police_station_edit/'.$row->id)?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?=base_url('settings/police_station_delete/'.$row->id)?>:" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a>
                    </td>
                  </tr>
                <?php } } ?>
                </tbody>
