         ...
         <div class="col-md-7">
            <div class="card card-success">
               <div class="card-header">
                  ...
                  <a class="btn btn-primary btn-sm float-right" href="<?=base_url('settings/police_stations')?>">Police Station List</a>
               </div>
               ...
               <?php endif; ?>
               <?php echo form_open_multipart("settings/police_station_add");?>
               <div class="card-body">
