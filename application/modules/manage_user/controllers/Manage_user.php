...
class Manage_user extends CI_Controller {
	...
	public function login() {
		...
		if ($this->form_validation->run() === true) {
			...
			$this->data['subview'] = 'auth/auth/login';
			$this->load->view('login/_layout_main', $this->data);
			// $this->_render_page('auth' . DIRECTORY_SEPARATOR . 'login/_layout_main', $this->data);
		}
	}
	...
	public function change_password() {
		...
		if ($this->form_validation->run() === false) {
			...
			//     'value' => $user->id,
			// ];
			$this->data['meta_title'] = $this->lang->line('edit_user_password');
			$this->data['domain_title'] = $this->lang->line('domain_title');

			$this->data['subview'] = 'auth/auth/change_password';
	...
	public function forgot_password() {
		...
		if ($this->form_validation->run() === false) {
			...
			$this->data['meta_title'] = $this->lang->line('forgot_password_heading');
			$this->data['domain_title'] = $this->lang->line('domain_title');
			$this->data['subview'] = 'auth/auth/forgot_password';
			$this->load->view('login/_layout_main', $this->data);
		} else {
	...
	public function edit_user($id) {
		...
		if (isset($_POST) && !empty($_POST)) {
			...
			if ($this->form_validation->run() === true) {
				...
				if ($this->ion_auth->update($user->id, $data)) {
					...
					$this->session->set_flashdata('message', $this->ion_auth->messages());
					redirect('manage_user/user_list', 'refresh');
					// redirect('auth', 'refresh');
					// $this->redirectUser();user_list
		...
		$this->data['meta_title'] = $this->lang->line('edit_user_heading');
		$this->data['domain_title'] = $this->lang->line('domain_title');
	...
	public function create_group() {
		...
		if ($this->form_validation->run() === true) {
			...
			if ($new_group_id) {
				...
				// redirect them back to the admin page
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				redirect("manage_user/groups", 'refresh');
			} else {
				$this->session->set_flashdata('message', $this->ion_auth->errors());
			}
		}
	...
	public function groups() {
		$this->data['groups'] = $this->db->get('groups')->result_array();
		$this->data['meta_title'] = $this->lang->line('edit_group_title');
		$this->data['domain_title'] = $this->lang->line('domain_title');
		$this->data['subview'] = 'groups';
		$this->load->view('backend/_layout_main', $this->data);
	}
	...
	public function edit_group($id) {
		...
		if ($this->config->item('admin_group', 'ion_auth') === $group->name) {
			...
			$this->data['group_status'] = 'readonly';
		}
	...
	public function delete($id) {
		...
		$this->Common_model->delete("users_groups","user_id",$id);
        redirect("manage_user/user_list", 'refresh');
    }
