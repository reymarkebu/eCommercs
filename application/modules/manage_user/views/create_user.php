    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
          <form action="<?=base_url('manage_user/create_user')?>" method="post">
            <div class="row">
              <div class="col-md-6">
                <div class="card card-info">
                  ...
                  <!-- /.form-group -->
                    ...
                    <div class="input-group mb-3">
                      <input type="text" name='phone' maxlength="11" class="form-control" placeholder="Phone">
                      <div class="input-group-append">
                        <div class="input-group-text">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group clearfix">
                          <div class="icheck-success d-inline">
                            <input type="checkbox" name="role[]" value="<?=$val['id']?>" id="checkboxPrimary<?=$val['id']?>">
