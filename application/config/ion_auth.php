 ...
 */
$config['site_title'] = "BG LMS"; // Site Title, example.com
$config['admin_email'] = "testingemail9400@gmail.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<div class="alert alert-success"> <a class="close" data-dismiss="alert">&times;</a>'; // Message start delimiter
$config['message_end_delimiter'] = '</div>'; // Message end delimiter
$config['error_start_delimiter'] = '<div class="alert alert-warning"> <i class="fa fa-warning"></i>'; // Error message start delimiter
